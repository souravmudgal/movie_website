...
import { MoveDetailsResponse } from './movie-details/movie-details.component';
@Injectable({
  providedIn: 'root',
})
export class MoivesListService {
  ...
  upComing_url =
    'https://api.themoviedb.org/3/movie/upcoming?api_key=5f9bfd5ab4dce1dd61c8ed83e1680d4e&language=en-US&page=1';

  latest_url =
    'https://api.themoviedb.org/3/movie/latest?api_key=5f9bfd5ab4dce1dd61c8ed83e1680d4e&language=en-US';
  ...
  public movie = new BehaviorSubject<MovieListName[]>([]);
  ...
  getMovie_OB(id: string): Observable<MoveDetailsResponse> {
    let url = `https://api.themoviedb.org/3/movie/${id}`;
    return this.http.get<MoveDetailsResponse>(url, {
      params: {
